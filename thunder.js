...
const thunderSound = new Audio('path/to/thunder-sound.mp3'); // Replace 'path/to/thunder-sound.mp3' with the actual path to your thunder sound file

const createLightning = function() {
  lightning = [];
  let lightningX1 = getRandomInteger(2, canvasWidth - 2);
  let lightningX2 = getRandomInteger(lightningX1 - 5, lightningX1 + 5);
  ...
  for (let l = 1; l < lightningStrikeLength; l++) {
    ...
    let lx2 = getRandomInteger(lx1 - 5, lx1 + 5);
